...
export class PC {
  constructor(
    ...
    public readonly lim: number,  // max quant in store; range = [0..lim]
  ...
  /** this formula creates [low-price, ramp-price, high-price] */
...
export class Planet extends MapTile {
  ...
  public prod: PC[]
  public cons: PC[]
  /** arrayify AND map from string to actual PC object */
  pcary(s: Item | Item[]) {
